                ...
                <section className=''>
                    ...
                    {rules ? (
                        <>
                            ...
                            <div className='w-full lg:w-[30%] lg:h-[29rem] h-full absolute top-0 lg:top-[9.5rem] lg:rounded-md lg:left-[35%] bg-white px-10 pb-16 z-40'>
                                ...
                                />
                                 <img 
                                    ...
                                    alt="close" 
                                    onClick={handleClose}
                                    className='cursor-pointer text-center absolute bottom-20 left-[49.4%] lg:hidden '
                                />
                            </div>
                        </>
                    ) : (
                        <div className={selectIcon ? 'hidden' : 'w-[8rem] lg:w-[5rem] mx-auto  right-10 lg:absolute bottom-8' }>
                        <p 
