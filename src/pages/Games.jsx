                ...
                <section className=''>
                    ...
                    {rules ? (
                        <>
                            ...
                            <div className='rules w-full lg:w-[30%] lg:h-[29rem] 2xl:h-[45rem] h-full iphone6:h-[120vh] absolute top-0 lg:top-[9.5rem] lg:rounded-md lg:left-[35%] bg-white px-10 pb-16 z-40'>
