...
export default function SpockCom({win,spockIcon,massege}) {
  return (
    <div>
    {win ? (
      // Kalah
      <div className="p-5 lg:p-8 bg-gradient-to-r z-20 absolute top-[4rem] iphone6:top-0 lg:top-[4rem] lg:right-[2.4rem] -right-4  from-cyan-11  to-cyan-12 rounded-full">
