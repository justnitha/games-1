...
export default function Paper({win,icons,selectIcon,massege}) {
  return (
    <div>
    {win ? (
      // menang
      <div>
        ...
        <div className="p-5 lg:p-8 bg-gradient-to-r z-20 absolute top-[4rem] iphone6:top-0 lg:top-[4rem] lg:left-[2.4rem]  from-blue-11  to-blue-12 rounded-full">
